...
public class AdapterDatosTareasProyecto extends RecyclerView.Adapter<AdapterDatosTareasProyecto.ViewHolder> {

    private ArrayList<String> listaTareasTarea, listaTareasDescripcion, listaTareasNumero;
    private Context context;

    public AdapterDatosTareasProyecto(Context context, ArrayList<String> listaTareasTarea, ArrayList<String> listaTareasDescripcion, ArrayList<String> listaTareasNumero) {
